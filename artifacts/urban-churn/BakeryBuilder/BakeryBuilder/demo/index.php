...
<head>
    ...
    <title>Urban Churn Bakery Orders - Plugin Demo</title>
    <link rel="stylesheet" href="assets/css/public.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Lato:wght@300;400;700&family=Caveat:wght@400;600;700&display=swap" rel="stylesheet">
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="demo-header">
        <h1>🧁 Urban Churn Bakery Orders Plugin Demo</h1>
        <p>Interactive WordPress Plugin with Animated Visual Effects</p>
    </div>
    
    <div class="demo-notice">
        <strong>Demo Mode:</strong> This is a demonstration of the WordPress plugin functionality. 
        In production, install this plugin in WordPress and use the shortcode <code>[bakery_order_form]</code> on any page.
        Form submissions in this demo will show success messages but won't actually save or send emails.
    </div>
        ...
        <div class="ucbo-form-container">
            <div class="ucbo-form-left">
                ...
                <form id="ucbo-order-form" class="ucbo-form">
                    ...
                    <!-- Step 3: Custom Options (Dynamic based on order type) -->
    ...
    <script src="assets/js/cake-renderer.js"></script>
    <script src="assets/js/public.js"></script>
    <script>
        var ucboData = {
            ajaxUrl: 'demo-handler.php',
            nonce: 'demo-nonce',
            leadTimeHours: 96
        };
        
        $(document).ready(function() {
            $('#ucbo-order-form').off('submit').on('submit', function(e) {
                e.preventDefault();
                ...
                setTimeout(function() {
                    console.log('Hiding form, showing success message'); // Debug log
                    
                    $('#ucbo-order-form').fadeOut(400, function() {
                        // After form is hidden, show success message
                        $('#ucbo-success-message').fadeIn(400, function() {
                            console.log('Success message displayed, triggering confetti'); // Debug log
                            
                            // Trigger full-page confetti AFTER success message is fully visible
        ...
        // QA helper presets removed per request
    </script>
</body>
</html>
