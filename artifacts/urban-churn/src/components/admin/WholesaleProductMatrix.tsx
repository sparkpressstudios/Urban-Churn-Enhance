            ...
            {sizes.map((size) => {
                ...
                return (
                    <td key={size.id} className="px-1 py-1 align-top">
                        <div className="space-y-1.5 rounded border border-slate-200 p-1.5 bg-white">
                            ...
                            {cell.enabled && (
                                <>
                                    <div className="space-y-0.5">
                                        <Label className="text-[10px] text-slate-600">Price ($)</Label>
                                        <Input
                                            type="number"
                                            step="0.01"
                                            min={0}
                                    ...
                                    <label className="flex items-center gap-1">
                                        ...
                                        />
                                        <span className="text-[10px] text-slate-700 font-medium">Track inventory</span>
                                    </label>
                                    {cell.manageStock && (
                                        <div className="space-y-0.5">
                                            <Label className="text-[10px] text-slate-600">Inventory</Label>
                                            <Input
                                                type="number"
                                                min={0}
                                                className="h-7 text-xs px-1"
