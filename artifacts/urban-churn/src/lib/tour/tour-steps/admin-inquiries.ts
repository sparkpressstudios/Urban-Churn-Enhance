...
export const adminInquiriesSteps: Step[] = [
    {
        ...
        content:
            "Manage contact form submissions, catering requests, fundraising leads, wholesale inquiries, and career applications in one pipeline.",
        skipBeacon: true,
    },
    {
    ...
    },
    {
        ...
        title: "Inquiry Types",
        content:
            "Filter by type — Contact, Wholesale, Catering, Fundraising, Bakery, or Career — to focus on specific requests.",
    },
    {
