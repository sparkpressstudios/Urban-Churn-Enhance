    ...
    <div className="min-h-screen" style={{ fontFamily: "'Space Grotesk', 'Poppins', sans-serif" }}>
      <SEO
        ...
        jsonLd={[
          ...
          { "@context": "https://schema.org", "@type": "IceCreamShop", name: "Urban Churn — Harrisburg", image: "https://urbanchurn.com/images/uc-locations-hero.jpg", address: { "@type": "PostalAddress", streetAddress: "1004 N 3rd Street", addressLocality: "Harrisburg", addressRegion: "PA", postalCode: "17104", addressCountry: "US" }, geo: { "@type": "GeoCoordinates", latitude: 40.2732, longitude: -76.8867 }, telephone: "+1-717-884-9396", url: "https://urbanchurn.com/locations", priceRange: "$$", servesCuisine: "Ice Cream", menu: "https://urbanchurn.com/pre-order", openingHoursSpecification: [{ "@type": "OpeningHoursSpecification", dayOfWeek: ["Monday", "Tuesday", "Wednesday", "Thursday"], opens: "14:00", closes: "21:00" }, { "@type": "OpeningHoursSpecification", dayOfWeek: ["Friday", "Saturday"], opens: "12:00", closes: "21:00" }] }
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
